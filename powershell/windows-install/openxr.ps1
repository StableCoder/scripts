...
try {
    ...
    if($null -eq ( ";C:\\openxr-sdk\\bin" | ? { [System.Environment]::GetEnvironmentVariable("PATH","Machine") -match $_ })) {
        # PATH
        [Environment]::SetEnvironmentVariable( "PATH", [System.Environment]::GetEnvironmentVariable("PATH","Machine") + ";C:\openxr-sdk\bin", [System.EnvironmentVariableTarget]::Machine )
    }
    ...
    if($null -eq ( ";C:\\openxr-sdk\\lib" | ? { [System.Environment]::GetEnvironmentVariable("CUSTOM_LIB","Machine") -match $_ })) {
        # CUSTOM_LIB
        [Environment]::SetEnvironmentVariable( "CUSTOM_LIB", [System.Environment]::GetEnvironmentVariable("CUSTOM_LIB","Machine") + ";C:\openxr-sdk\lib", [System.EnvironmentVariableTarget]::Machine )
    }
} catch {
