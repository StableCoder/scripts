...
try {
    ...
    Invoke-WebRequest -Uri https://aka.ms/vs/16/release/vs_$VS_Package.exe -OutFile .\vs_installer.exe -UseBasicParsing
    ...
    Write-Host "Visual Studio 2019 ($VS_Package) setup complete."
} catch {
    Write-Host "Visual Studio 2019 ($VS_Package) setup failed."
    exit 1
}