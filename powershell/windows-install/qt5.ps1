...
try {
    ...
    Invoke-WebRequest -Uri http://mirror.csclub.uwaterloo.ca/qtproject/archive/online_installers/3.0/qt-unified-windows-x86-3.0.5-online.exe -OutFile qt5.exe -UseBasicParsing
